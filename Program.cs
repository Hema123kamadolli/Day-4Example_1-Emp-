...
List<Employee> employees = new List<Employee>() {
    new Employee() { Id=1, Name="Viraj", Designation="Developer", DOJ=new DateTime(day:12,month:11,year:2022)} ,
    ...
    new Employee() { Id=6, Name="Rithesh", Designation="Developer", DOJ=new DateTime(day:12,month:11,year:2021)},
    };
